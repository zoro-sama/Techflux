...
// Babel plugin for JSX transformation - adds element tracking attributes
...
const babelMetadataPlugin = ({ types: t }) => {
  ...
  return {
    name: "element-tracking-plugin",
    visitor: {
      // Wrap React components (capitalized JSX) with tracking divs,
      ...
      // Add tracking attributes to native HTML elements (lowercase JSX)
      JSXOpeningElement(jsxPath, state) {
        ...
        // Skip if already has tracking attributes
